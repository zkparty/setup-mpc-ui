...
* @returns {Uint8Array}
*/
export function contribute(params, entropy, report_progress, set_hash) {
    try {
        ...
        wasm.contribute(8, ptr0, len0, ptr1, len1, addBorrowedObject(report_progress), addBorrowedObject(set_hash));
...
export const __wbg_call_5100c57aba7ad602 = function(arg0, arg1, arg2, arg3) {
    try {
